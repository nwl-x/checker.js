...
describe('is.string.base64 | isBase64', () => {
  test.each`
    arg                                                                                                                                         | expected
    ${null}                                                                                                                                     | ${false}
    ${undefined}                                                                                                                                | ${false}
    ...
    ${new Map()}                                                                                                                                | ${false}
    ${Symbol()}                                                                                                                                 | ${false}
    ${'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAA1JREFUGFdj+P///38ACfsD/QVDRcoAAAAASUVORK5CYII='} | ${true}
    ${'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAA1JREFUGFdj+P///38ACfsD/QVDRcoAAAAASUVORK5CYII='}                       | ${true}
  `(`With "$arg" -> $expected`, ({ arg, expected }) => {
    expect(isBase64(arg)).toBe(expected)
    expect(is.string.base64(arg)).toBe(expected)
  })
})
