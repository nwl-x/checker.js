...
export const isNumber = <T>(arg: T) =>
  (getType(arg) === 'number' && !Number.isNaN(arg as number)) || arg instanceof Number
...
export const isPrimitive = <T>(arg: T) =>
  isNumber(arg) || isString(arg) || isBoolean(arg) || isUndefined(arg) || isNull(arg) || isSymbol(arg)
